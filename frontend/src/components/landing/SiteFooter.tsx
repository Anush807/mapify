...
const GITHUB_URL = 'https://github.com/Anush807';

/**
 * lucide dropped brand marks in v1, so the GitHub logo is inlined. `currentColor`
 * lets it inherit the same muted -> foreground hover as the text links beside it.
 */
      ...
      <div className="container flex flex-col gap-4 py-8 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav className="flex items-center gap-3 text-sm text-muted-foreground">
          ...
          <a
            ...
            aria-label="Anush807 on GitHub"
            title="Anush807 on GitHub"
            className="rounded-sm p-0.5 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
